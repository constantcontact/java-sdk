...
public interface ContactTrackingService {
    ...
    Observable<Paged<BounceReport>> getBounceReports(@Path("contactId") String contactId, @Query("created_since") String createdSinceDate, @Query("limit") int limit);
    ...
    Observable<Paged<ClickReport>> getClickReports(@Path("contactId") String contactId, @Query("created_since") String createdSinceDate, @Query("limit") int limit);
    ...
    Observable<Paged<ClickReport>> getClickReports(@Path("contactId") String contactId, @Path("linkId") String linkId, @Query("created_since") String createdSinceDate, @Query("limit") int limit);
    ...
    Observable<Paged<ForwardReport>> getForwardReports(@Path("contactId") String contactId, @Query("created_since") String createdSinceDate, @Query("limit") int limit);
    ...
    Observable<Paged<OpenReport>> getOpenReports(@Path("contactId") String contactId, @Query("created_since") String createdSinceDate, @Query("limit") int limit);
    ...
    Observable<Paged<SendReport>> getSendReports(@Path("contactId") String contactId, @Query("created_since") String createdSinceDate, @Query("limit") int limit);
    ...
    Observable<Paged<OptOutReport>> getOptOutReports(@Path("contactId") String contactId, @Query("created_since") String createdSinceDate, @Query("limit") int limit);
    ...
    Observable<Paged<BaseTrackingReport>> getAllReports(@Path("contactId") String contactId, @Query("created_since") String createdSinceDate, @Query("limit") int limit);
