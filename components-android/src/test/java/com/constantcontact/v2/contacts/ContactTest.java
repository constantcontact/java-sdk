...
public class ContactTest {
    ...
    private void runAssertions(Contact contact) {
        ...
        assertThat(contact.getAddresses(), is(ADDRESSES));
        assertThat(contact.getContactLists(), is(CONTACT_LISTS));
        assertThat(contact.getEmailAddresses(), is(EMAIL_ADDRESSES));
        assertThat(contact.getNotes(), is(NOTES));
        assertThat(contact.getCustomFields(), is(CUSTOM_FIELDS));
    }
}
