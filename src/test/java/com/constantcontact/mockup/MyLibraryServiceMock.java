...
public class MyLibraryServiceMock extends MyLibraryService {
	 ...
	 * 
	 * @throws {@link com.constantcontact.exceptions.service.ConstantContactServiceException}
	 *         When something went wrong in the Constant Contact flow or an
	 *         error is returned from server.
	 * @return The
	 *         {@link com.constantcontact.components.library.info.MyLibrarySummary}
	 *         Data
	 */
	@Override
	public MyLibrarySummary getLibraryInfo()
		...
		try {
			...
			summary = Component.fromJSON(
					MockedServerResponses.getLibraryInfoMyLibraryServiceData,
					MyLibrarySummary.class);
	 ...
	 * 
	 * @param sortBy
	 *            The method to sort by. See
	 *            {@link com.constantcontact.components.library.folder.MyLibraryFolder.FolderSortOptions}
	 *            . Leave null to not use
	 * @param limit
	 ...
	 *         of
	 *         {@link com.constantcontact.components.library.folder.MyLibraryFolder}
	 *         Data
	 */
	@Override
	public ResultSet<MyLibraryFolder> getLibraryFolders(
			FolderSortOptions sortBy, Integer limit)
			throws ConstantContactServiceException {
		...
		try {
			...
			folders = Component
					.resultSetFromJSON(
							MockedServerResponses.getLibraryFoldersMyLibraryServiceData,
							MyLibraryFolder.class);
		} catch (ConstantContactComponentException e) {
			throw new ConstantContactServiceException(e);
		}
	 ...
	 *             {@link com.constantcontact.exceptions.ConstantContactException#hasErrorInfo()}
	 * <br/>
	...
	public MyLibraryFolder addLibraryFolder(
			MyLibraryFolder folder) throws ConstantContactServiceException {
		...
		try {
			newFolder = Component.fromJSON(
					MockedServerResponses.addLibraryFolderMyLibraryServiceData,
					MyLibraryFolder.class);
		} catch (ConstantContactComponentException e) {
			throw new ConstantContactServiceException(e);
		}
	...
	public MyLibraryFolder getLibraryFolder(String folderId)
		...
		try {
			...
			folder = Component.fromJSON(
					MockedServerResponses.getLibraryFolderMyLibraryServiceData,
					MyLibraryFolder.class);
		} catch (ConstantContactComponentException e) {
			throw new ConstantContactServiceException(e);
		}
	 ...
	 * @return The added
	 *         {@link com.constantcontact.components.library.folder.MyLibraryFolder}
	 *         , or Null if includePayload was false.
	 * @throws com.constantcontact.exceptions.service.ConstantContactServiceException
	 *             Thrown when :
	 *             <ul>
	 *             <li>something went wrong either on the client side;</li>
	 ...
	 */
	@Override
	public MyLibraryFolder updateLibraryFolder(
			MyLibraryFolder folder, Boolean includePayload)
			throws ConstantContactServiceException {

		if (folder == null || folder.getId() == null
				|| folder.getId().trim().equals("")) {
			throw new IllegalArgumentException(Config.instance()
					.getErrorFolderIdNull());
		}
		...
		try {
			updateFolder = Component
					.fromJSON(
							MockedServerResponses.updateLibraryFolderMyLibrariServiceData,
							MyLibraryFolder.class);
		} catch (ConstantContactComponentException e) {
			throw new ConstantContactServiceException(e);
		}
	 ...
	 */
	@Override
	public void deleteLibraryFolder(String folderId)
			throws ConstantContactServiceException {
	 ...
	 * 
	 * @param type
	 *            - The type of files to return. Null for default.
	 * @param sortBy
	 *            - The way to sort results. Null for default
	 * @param limit
	 *            - The number of results to return per page.
	 * @return A
	 *         {@link com.constantcontact.components.generic.response.ResultSet}
	 *         of
	 *         {@link com.constantcontact.components.library.file.MyLibraryFile}
	 *         in case of success; an exception is thrown otherwise.
	 * @throws com.constantcontact.exceptions.service.ConstantContactServiceException
	 *             Thrown when :
	 *             <ul>
	 *             <li>something went wrong either on the client side;</li>
	 ...
	 */
	@Override
	public ResultSet<MyLibraryFile> getLibraryTrash(
			MyLibraryFile.Type type, MyLibraryFile.SortBy sortBy, Integer limit)
			throws ConstantContactServiceException {
		ResultSet<MyLibraryFile> files = null;

		try {

			files = Component.resultSetFromJSON(
					MockedServerResponses.getLibraryTrashMyLibraryServiceData,
					MyLibraryFile.class);
		} catch (ConstantContactComponentException e) {
			throw new ConstantContactServiceException(e);
		}
	 ...
	 *            - The type of files to return. Null for default.
	 * @param source
	 *            - The source of the files. Null for default.
	 * @param sortBy
	 *            - The way to sort results. Null for default
	 * @param limit
	 *            - The number of results to return per page.
	...
	public ResultSet<MyLibraryFile> getLibraryFiles(
			MyLibraryFile.Type type, ImageSource source,
			MyLibraryFile.SortBy sortBy, Integer limit)
			throws ConstantContactServiceException {
		ResultSet<MyLibraryFile> files = null;
		...
		try {
			...
			files = Component.resultSetFromJSON(
					MockedServerResponses.getLibraryFilesMyLibraryServiceData,
					MyLibraryFile.class);
		} catch (ConstantContactComponentException e) {
			throw new ConstantContactServiceException(e);
		}
	...
	public ResultSet<MyLibraryFile> getLibraryFilesByFolder(
		...
		try {
			...
			files = Component
					.resultSetFromJSON(
							MockedServerResponses.getLibraryFilesByFolderMyLibraryServiceData,
							MyLibraryFile.class);
		} catch (ConstantContactComponentException e) {
			throw new ConstantContactServiceException(e);
		}
	...
	public MyLibraryFile getLibraryFile(String fileId)
		...
		try {
			...
			file = Component.fromJSON(
					MockedServerResponses.getLibraryFileMyLibraryServiceData,
					MyLibraryFile.class);
		} catch (ConstantContactComponentException e) {
			throw new ConstantContactServiceException(e);
		}
	 ...
	 *            The Folder to update.
	 * @param includePayload
	 *            If the result should be the updated File or NULL (defaults to
	 *            true if left null)
	 * @return The added
	 *         {@link com.constantcontact.components.library.file.MyLibraryFile}
	 *         , or Null if includePayload was false.
	...
	public MyLibraryFile updateLibraryFile(
			MyLibraryFile file, Boolean includePayload)
			throws ConstantContactServiceException {

		if (file == null || file.getId() == null
				|| file.getId().trim().equals("")) {
			throw new IllegalArgumentException(Config.instance()
					.getErrorFileIdNull());
		}
		...
		try {
			...
			updateFile = Component
					.fromJSON(
							MockedServerResponses.updateLibraryFileMyLibraryServiceData,
							MyLibraryFile.class);
		} catch (ConstantContactComponentException e) {
			throw new ConstantContactServiceException(e);
		}
	 ...
	 * 
	 * @param fileId
	 *            A varargs list of fileIds to return results for.
	 * @throws {@link com.constantcontact.exceptions.service.ConstantContactServiceException}
	 *         When something went wrong in the Constant Contact flow or an
	 *         error is returned from server.
	 * @return The {@link java.util.List} of
	 *         {@link com.constantcontact.components.library.info.UploadStatus}
	 *         Data
	 */
	@Override
	public List<UploadStatus> getLibraryFilesUploadStatus(
			String... fileId) throws ConstantContactServiceException {
		...
		try {
			...
			uploadStatuses = Component
					.listFromJSON(
							MockedServerResponses.getLibraryFilesUploadStatusMyLibraryServiceData,
							UploadStatus.class);
		} catch (ConstantContactComponentException e) {
			throw new ConstantContactServiceException(e);
		}
	 ...
	 * 
	 * @param folderId
	 *            The folder to put the files in
	 * @param body
	 *            The JSON body [an array of fileIds]
	 * @throws {@link com.constantcontact.exceptions.service.ConstantContactServiceException}
	 *         When something went wrong in the Constant Contact flow or an
	 *         error is returned from server.
	 * @throws IllegalArgumentException
	 *             Thrown when data validation failed due to incorrect / missing
	 *             parameter values. <br/>
	 *             The exception also contains a description of the cause.<br/>
	 *             Error message is taken from one of the members of
	 *             {@link com.constantcontact.util.Config}
	 * @return The {@link java.util.List} of
	 *         {@link com.constantcontact.components.library.info.MoveResults}
	 *         Data
	 */
	@Override
	public List<MoveResults> moveLibraryFiles(
			String folderId, String body)
			throws ConstantContactServiceException {
		...
		try {
			...
			movedResults = Component.listFromJSON(
					MockedServerResponses.moveLibraryFilesMyLibraryServiceData,
					MoveResults.class);
		} catch (ConstantContactComponentException e) {
			throw new ConstantContactServiceException(e);
		}
	 ...
	 * 
	 * @param request
	 *            The {@link com.constantcontact.util.http.MultipartBody} to
	 *            upload
	 ...
	 */
	@Override
	public String addLibraryFile(MultipartBody request)
			throws ConstantContactServiceException {
	...
	private static void checkForResponseError(RawApiResponse response,
			String url) throws ConstantContactServiceException {
		if (response.isError()) {
			throw ConstantContactExceptionFactory.createServiceException(
					response, url);
		}
	}
	
	public MyLibraryServiceMock(String accessToken, String apiKey) {
