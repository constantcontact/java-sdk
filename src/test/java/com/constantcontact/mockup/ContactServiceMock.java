...
public class ContactServiceMock extends ContactService {
  ...
  @Override
  public ResultSet<Contact> getContacts(Integer limit, String modifiedSinceTimestamp, Contact.Status status)
  ...
  public ResultSet<Contact> getContacts(Pagination pagination) throws ConstantContactServiceException {
    ...
    try {
      pageResultSet = Component.resultSetFromJSON(
          MockedServerResponses.getContactsContactServicesData,
          Contact.class);
    } catch (Exception e) {
      throw new ConstantContactServiceException(e);
   ...
   * ConstantContact server side.
   *
   * @param contact {@link com.constantcontact.components.contacts.Contact} to
   *                add.
   *
   ...
   *
   * @param contact {@link com.constantcontact.components.contacts.Contact} to be
   *                updated.
   *
