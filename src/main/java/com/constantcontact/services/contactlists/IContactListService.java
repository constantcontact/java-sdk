...
public interface IContactListService extends IBaseService {
	 ...
	 */
	List<ContactList> getLists(String modifiedSinceTimestamp) throws ConstantContactServiceException;
	 ...
	 * @throws ConstantContactServiceException When something went wrong in the Constant Contact flow or an error is returned from server.
	 */
	ContactList addList(ContactList list) throws ConstantContactServiceException;
	 ...
	 * @throws ConstantContactServiceException When something went wrong in the Constant Contact flow or an error is returned from server.
	 */
	ContactList getList(String listId) throws ConstantContactServiceException;
     ...
     * @throws ConstantContactServiceException When something went wrong in the Constant Contact flow or an error is returned from server.
     */
    ContactList updateList(ContactList list) throws ConstantContactServiceException;
