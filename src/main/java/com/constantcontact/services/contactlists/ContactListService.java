...
public class ContactListService extends BaseService implements IContactListService {
    ...
    public ResultSet<Contact> getContactsFromList(String listId, Integer limit, String modifiedSinceTimestamp) throws ConstantContactServiceException {
        ...
        return getContactsFromList(listId, limit, modifiedSinceTimestamp, null);
    }
    ...
    public ResultSet<Contact> getContactsFromList(Pagination pagination) throws ConstantContactServiceException {
        ...
        return getContactsFromList(null, null, null, pagination);
    }
    ...
    private ResultSet<Contact> getContactsFromList(String listId, Integer limit, String modifiedSinceTimestamp, Pagination pagination) throws ConstantContactServiceException {
        ResultSet<Contact> contacts = null;
        String url;

        if (pagination == null) {
            url = String.format("%1$s%2$s", Config.instance().getBaseUrl(), String.format(Config.instance().getListContacts(), listId));
