        ...
        new AsyncTask<Void, Void, List<ContactList>>() {
            ...
            protected void onPreExecute() {
                mProgressDialog = ProgressDialog
                        .show(ContactListsActivity.this, null, getString(R.string.kMsgLoading), true, false);
            }
            ...
            protected void onPostExecute(List<ContactList> contactList) {
                ...
                if (mError != null) {
                    ...
                    new AlertDialog.Builder(ContactListsActivity.this).setTitle("Server Error").setMessage(errorMessage)
                ...
                ArrayAdapter<Item> contactListAdapter = new ArrayAdapter<Item>(getBaseContext(),
                        android.R.layout.simple_list_item_multiple_choice, (Item[]) itemList.toArray(new Item[]{}));
