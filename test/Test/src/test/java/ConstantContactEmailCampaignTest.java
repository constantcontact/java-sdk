...
import mockup.EmailCampaignScheduleServiceTest;
import mockup.EmailCampaignServiceTest;
...
public class ConstantContactEmailCampaignTest {
    ...
    public void beforeTests(){
        ...
        constantContact.setEmailCampaignService(new EmailCampaignServiceTest());
        constantContact.setEmailCampaignScheduleService(new EmailCampaignScheduleServiceTest());
    }
